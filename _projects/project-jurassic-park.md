...
meta:
  ...
  - "The performance combines motion tracking, live cinema, voice direction, and an uncanny AI-edited remix of the film."
link:
...
Jurassic Park is a participatory cinematic performance that reimagines the film through a real-time collaboration between audience members and an AI director named Mr. Neural. Staged at the Center for Performance Research in NYC, the project merges motion-tracking technology and live cinema to invert the typical AI art dynamic: instead of humans prompting machines, the AI prompts the humans. Mr. Neural directs participants via voice commands and lighting cues, orchestrating a hybrid film shoot where the audience acts as both cast and crew. The experience culminates in a screening of an uncanny, AI-edited remix of the movie, exploring themes of surveillance, automation, and algorithmic control.
